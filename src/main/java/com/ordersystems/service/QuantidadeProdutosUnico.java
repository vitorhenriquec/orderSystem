...
public class QuantidadeProdutosUnico implements RegraPromocao{
	...
	public Map<String, String> gerarInformacao(double valorPedido) {
		...
		String mensagem= "Promoção dos 3%: A sua compra tem mais do que três produtos diferentes e o valor da compra teve 3% de desconto";
