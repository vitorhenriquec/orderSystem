...
public class ProdutoController {
	...
	public ResponseEntity<?> adicionarProduto(@RequestBody Produto produto, RedirectAttributes redirectAttributes, 
											  BindingResult result){
		try {
			produtoService.adicionar(produto);
			redirectAttributes.addFlashAttribute("success", "Adicionado com sucesso");
		}
		catch(Exception e){
